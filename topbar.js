...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://itidzioouqjbwnyvekkw.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_Eb38zFsU1V6OUxXzFd8ysg_AgMn6Zzt';
...
.topbar {
  ...
  padding: max(75px, env(safe-area-inset-top)) max(14px, env(safe-area-inset-right)) 10px max(14px, env(safe-area-inset-left));
