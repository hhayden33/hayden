...
| [main.html](main.html) | Daily overview — Day Ring, Calendar (read-only Google Calendar summary — see [GOOGLE_CALENDAR_SETUP.md](GOOGLE_CALENDAR_SETUP.md)), Goal Ticker, To Do list, 7-Day Planner, Night Routine |
